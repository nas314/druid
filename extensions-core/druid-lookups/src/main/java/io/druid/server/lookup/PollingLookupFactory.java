...
public class PollingLookupFactory implements LookupExtractorFactory
{
  ...
  )
  {
    ...
    this.pollingLookup = new PollingLookup(this.pollPeriod, this.dataFetcher, this.cacheFactory);
  }
  ...
  {
    if (!started.get()) {
      LOGGER.info("started polling lookup");
  ...
  public boolean close()
  {
    ...
    if (started.getAndSet(false)) {
      LOGGER.info("shutting down polling lookup");
      pollingLookup.close();
    }
    return !started.get();
  }
  ...
  {
    if (lookupExtractorFactory == null) return false;
  ...
  public boolean equals(Object o)
  {
    ...
    return cacheFactory != null ? cacheFactory.equals(that.cacheFactory) : that.cacheFactory == null;
