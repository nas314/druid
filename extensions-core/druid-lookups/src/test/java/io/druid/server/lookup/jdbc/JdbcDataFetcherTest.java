...
public class JdbcDataFetcherTest
{
  ...
  {
    Map<String, String> retMap = jdbcDataFetcher.fetchAll();
    Assert.assertEquals("maps should match", lookupMap, retMap);
  }

  @Test
  public void testFetchKeys()
  {
    Map<String, String> actualMap = jdbcDataFetcher.fetch(lookupMap.keySet());
    Assert.assertEquals(lookupMap, actualMap);
  }
